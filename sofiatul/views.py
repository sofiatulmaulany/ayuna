...
from maulany.models import Transaksi, DetailTransaksi
...
from maulany.forms import CartAddProductForm
from maulany.keranjang import Cart
import datetime
...
def detail(request, slug):
    detailkategori = get_object_or_404(Kategori, slug=slug)
    produk = detailkategori.produks.order_by('-id')
